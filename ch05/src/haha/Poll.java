...
public class Poll extends JFrame {
	private static final long serialVersionUID = 3475103418412407824L;

	public Poll() {
		super("Vote for Pewdipie or T-Series");

		Container c = getContentPane();
		c.setBackground(Color.WHITE);
		PollDisplayPanel chart = new PollDisplayPanel("Pewdipie", "T-Series", "Nothing");
