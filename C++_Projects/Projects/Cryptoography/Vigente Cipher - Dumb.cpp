...
void decryption(const vector<string> * encryptionTable, const map<string, int> * mapping) {
	...
	// Output frequency of each letter (have), index of coincidence (have), predicted keyword (nope), deciphered plaintext (nope)
	/*char frequentLetter = 'A';
	double frequentLetterFrequency = indexCoincidence[0]/n;*/
	...
	for (int i = 0; i < 26; i++) {
		...
		/*if (frequentLetterFrequency < frequency) {
			frequentLetter = i + 'A';
			frequentLetterFrequency = frequency;
		}*/
	}
...
string decrypt(string cipher, string key) {
	...
	//cout << "Deciphered plaintext: " << decryption << endl;
	return decryption;
}
